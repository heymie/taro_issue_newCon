import { internal_safe_set, internal_safe_get, setIsUsingDiff } from '@tarojs/taro';
            ...
            function BaseComponent(props) {
                ...
                this.setData = function (obj, callback) {
                    ...
                    Object.keys(obj).forEach(function (key) {
                        internal_safe_set(this$1.state, key, obj[key]);
                    });
                    ...
                    for (var i = 0; i < keys.length; i++) {
                        ...
                        for (var j = 0; j < resultKeys.length; j++) {
                            ...
                            if (resultKey.startsWith(key) ||
                                ...
                                args.push(internal_safe_get(current, key));
                            }
                        }
                    }
                    if (args.length) {
